...
public sealed class NoteService : INoteService
{
    ...
    public async Task<IReadOnlyList<NoteDto>> ListAsync(string relatedType, Guid relatedId, CancellationToken ct) =>
        await _db.Notes.AsNoTracking()
            ...
            .Select(n => new NoteDto(n.Id, n.Title, n.Body, n.RelatedType, n.RelatedId, n.AuthorUserId, n.CreatedAt))
            .ToListAsync(ct);

    public async Task<IReadOnlyList<NoteDto>> ListAllAsync(CancellationToken ct) =>
        await _db.Notes.AsNoTracking()
            .OrderByDescending(n => n.CreatedAt)
            .Take(500)
            .Select(n => new NoteDto(n.Id, n.Title, n.Body, n.RelatedType, n.RelatedId, n.AuthorUserId, n.CreatedAt)
            {
                ZohoModifiedTime = n.ZohoModifiedTime,
                AuthorName       = n.AuthorUserId == null
                    ? null
                    : _db.Users.Where(u => u.Id == n.AuthorUserId).Select(u => u.UserName).FirstOrDefault(),
            })
            .ToListAsync(ct);
    ...
    public async Task<NoteDto?> GetAsync(Guid id, CancellationToken ct)
    {
        ...
        return n == null ? null : new NoteDto(n.Id, n.Title, n.Body, n.RelatedType, n.RelatedId, n.AuthorUserId, n.CreatedAt);
    }
