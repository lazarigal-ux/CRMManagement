...
public sealed class UpsertModel : PageModel
{
    ...
    [BindProperty] public TicketUpsertDto Input { get; set; } =
        new(null, "", "", null, null, null, "Open", "Medium", "Issue", "Web", null);
    ...
    public async Task<IActionResult> OnGetAsync(Guid? id, CancellationToken ct)
    {
        if (id is { } gid)
        {
            ...
            Input = new TicketUpsertDto(d.Id, d.TicketNumber, d.Subject, d.Description, d.AccountId, d.ContactId, d.Status, d.Priority, d.Type, d.Channel, d.OwnerUserId);
        }
        return Page();
    }
